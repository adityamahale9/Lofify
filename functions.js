...
if (!playlist.includes(audio_url)) {
        playlist.push(audio_url);
    }
    currentIndex = playlist.indexOf(audio_url);
...
function playNext() {
    ...
    PlayAudio(playlist[currentIndex], "song-" + currentIndex);
}
...
const audio = document.getElementById("player"); // Ensure correct ID
if (audio) {
