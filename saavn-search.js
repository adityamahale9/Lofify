...
if (bitrate_i == 4) {quality = 320} else {quality = 160;}
    ...
    results_objects[song_id] = {
      ...
      results.push(`
      <div class="text-left song-container" style="margin-bottom:20px;border-radius:10px;background-color:#36454F;padding:10px;">
      <div class="row" style="margin:auto;">
          ...
          <div class="col" style="border-style:none;padding:2px;">
              ...
              <button class="btn btn-primary song-btn" type="button" style="margin:0px 2px;" onclick='AddDownload("${song_id}")'>⬇️</button>
...
} else {doSaavnSearch('Sanam puri',1);}
